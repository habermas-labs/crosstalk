...
| D-33 | theoretical-sources-annotated.md | ZK/literature | Living annotated bibliography of CT theoretical sources; alphabetical by theorist; CT-relevance framing; 17 initial entries including Austin, Bakhtin, Clark & Chalmers, Grice, Habermas, Searle, Vygotsky and others; discipline tags descriptive not categorical|
...
| D-37 | hybrid-intelligence-field-assessment.md | ZK/permanent | Assessment of the hybrid intelligence research field; integrated vs. hybrid intelligence distinction; Moravec's paradox as design principle; field-level critique of human-centric framing; CT's theoretical positioning relative to emerging HI literature |
| D-38 | fleeting-og-yb-trio-terminology.md | ZK/fleeting | Terminology note from YB session 20260527; OG/YB naming convention for the two model trios; forward links to relevant permanent notes pending |
| D-39 | fleeting-temporal-arc-session-geometry.md | ZK/fleeting | Session geometry as dynamic rather than static; within-session and across-session geometric transformation; conductor developmental arc mapped onto dimensionality ladder; routes to ct-tetras.md and dimensionality-ladder.md |
| D-40 | fleeting-ct-information-asymmetry.md | ZK/fleeting | Structural information asymmetry in CT session architecture; conductor holds full session overview, models see only directed content; architectural rather than ontological asymmetry; design questions for symmetric distributed metacognition; routes to distributed-metacognition.md and ct-tetras.md |
---
